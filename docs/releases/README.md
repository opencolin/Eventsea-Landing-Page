...
| **v0.1.2** | Drafts ready | Show HN proof drop — audit-200 long-form, YC + AI Engineer satellite audits, sample private audit, launch playbook | `release/v0.1.2-show-hn-proof` | [`../marketing/`](../marketing/) |
